...
(function (APP) {
    ...
    const translations = {
        en: {
            ...
            'my-discoveries': 'My Own Discoveries',
            ...
            'chapter4-post-tag-problem': "📖 Supplementary Reading: After 100 Years, Can We Finally Crack Post's Problem of Tag? A Story of Computational Irreducibility, and More",
            'chapter5-multicomputation-numbers': '📖 Further Reading: Multicomputation with Numbers—The Case of Simple Multiway Systems',
            'chapter9-wpp': '📖 Further Reading: Wolfram Physics Project',
            'chapter9-path-fundamental-theory': "📖 Further Reading: Finally We May Have a Path to the Fundamental Theory of Physics—and It's Beautiful",
            'chapter9-second-law': '📖 Further Reading: Computational Foundations for the Second Law of Thermodynamics',
            'chapter11-simplest-utm': '📖 Further Reading: The Prize Is Won—the Simplest Universal Turing Machine Is Proved',
            'chapter12-ruliad': '📖 Further Reading: The Concept of the Ruliad',
            'chapter12-physicalization-metamathematics': '📖 Further Reading: The Physicalization of Metamathematics and Its Implications for the Foundations of Mathematics',
            'play': '▶ Play',
            'pause': '⏸ Pause',
        ...
        zh: {
            ...
            'chapter4-post-tag-problem': '📖 补充阅读：100年后，我们能最终破解Post的标签问题吗？一个关于计算不可约性的故事，以及更多内容',
            'chapter5-multicomputation-numbers': '📖 扩展阅读：多重计算与数字：简单多路系统的案例',
            'chapter9-wpp': '📖 扩展阅读：Wolfram Physics Project',
            'chapter9-path-fundamental-theory': '📖 扩展阅读：我们可能终于找到了一条通往物理学基本理论的道路……而且它很美',
            'chapter9-second-law': '📖 扩展阅读：热力学第二定律的计算基础',
            'chapter11-simplest-utm': '📖 扩展阅读：我们终于证明了最简单的普适图灵机',
            'chapter12-ruliad': '📖 扩展阅读：The Concept of the Ruliad',
            'chapter12-physicalization-metamathematics': '📖 扩展阅读：元数学的物理化及其对数学基础的影响',
            'play': '▶ 播放',
            'pause': '⏸ 暂停',
        ...
        ja: {
            ...
            'preface-making-nks': '📖 Supplementary Reading: The Making of A New Kind of Science',
            'chapter3-combinators': '📖 Further Reading: Combinators—A Centennial View',
            'chapter4-post-tag-problem': "📖 Supplementary Reading: After 100 Years, Can We Finally Crack Post's Problem of Tag?",
            'chapter5-multicomputation-numbers': '📖 Further Reading: Multicomputation with Numbers—The Case of Simple Multiway Systems',
            'chapter9-wpp': '📖 Further Reading: Wolfram Physics Project',
            'chapter9-path-fundamental-theory': "📖 Further Reading: Finally We May Have a Path to the Fundamental Theory of Physics—and It's Beautiful",
            'chapter9-second-law': '📖 Further Reading: Computational Foundations for the Second Law of Thermodynamics',
