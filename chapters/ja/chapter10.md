...
[Additive Cellular Automata](annotation:additive-cellular-automata) (例: [Rule 60](annotation:rule-60)) に基づくシステム: その入れ子構造により、この章で説明するさまざまなセンシングおよび分析方法を使用して規則性を識別できます。その相加性により、暗号解析は比較的簡単になります。
